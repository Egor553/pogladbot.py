...
* 24 часа на обработку — быстро и надежно ⏱️"""
    ...
    # Вставка видео (замени 'YOUR_VIDEO_FILE_ID' на file_id видео после редактирования в CapCut/FFmpeg: убери водяной знак, добавь надпись "Погладь")
...
9. ★★★★★ Идеально"""
    ...
    # Призыв к действию
    call_to_action = "Сделай заказ сейчас и почувствуй удобство!"
    keyboard = InlineKeyboardMarkup(inline_keyboard=[
        [InlineKeyboardButton(text="Сделать заказ", callback_data="make_order")],
    ])
